...
class GaussianMixtureModel():
    ...
    def _expectation(self, X):
        ...
        a = np.sum(weighted_likelihoods, axis=1)
        sum_likelihoods = np.expand_dims(a, axis=1)
        ...
        b = np.max(self.responsibility, axis=1)
        self.responsibilities.append(b)
